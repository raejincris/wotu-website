// Sveltia CMS OAuth bridge — Cloudflare Worker.
// Source: https://github.com/sveltia/sveltia-cms-auth (MIT licensed).
// Handles GitHub OAuth flow on behalf of the static CMS so that the
